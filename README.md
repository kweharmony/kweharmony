...
Simple schedule tracker because I kept missing classes 😅
...
- Making databases go brrrr (optimization is addictive)
- Integrating AI into web apps in creative ways
- Cloud stuff and DevOps magic
- Better software architecture patterns (because spaghetti code isn't sustainable)
